...
当前私人安装版本为 1.0.11 (11)，内置共享网页核心仍为 v886。v886 真机复验仍会跳动，进一步定位为 SwiftUI 键盘安全区先缩小 WKWebView、WebKit 随后又滚动聚焦输入框造成双重动画；1.0.11 在原生根视图忽略键盘安全区，使 WKWebView 外框在键盘开合时保持固定。电话页继续复用网页版输入结构，角色播放完成后的原生录音强制重建继续保留。
