...
test('v997 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-997/);
  assert.match(html,/sw\.js\?v=997&r=v997-call-settings-pat-qixi-1/);
});
