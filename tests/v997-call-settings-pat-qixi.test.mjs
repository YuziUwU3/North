...
test('v1007 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1007/);
  assert.match(html,/sw\.js\?v=1007&r=v1007-background-inbox-moments-inner-1/);
});
