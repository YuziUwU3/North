...
assert.match(chatApiSource,/else if\(chatRouteSessionPage\(\)\)opt\.aux=false/);
...
assert.match(source,/const _wxP=c\.p==='wechat'\?' wx-premium':'';\s*app\.innerHTML='<div class="page'\+_wxL\+_wxP\+'">'\+html\+'<\/div>';\s*chatRouteMount\(c\);/);
