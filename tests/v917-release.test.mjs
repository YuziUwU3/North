...
test('v931 source and private 1.0.55 versions are aligned', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 55;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.55;/g) || []).length, 12);
