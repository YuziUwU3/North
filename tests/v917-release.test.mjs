...
test('v943 source and private 1.0.67 versions are aligned', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 67;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.67;/g) || []).length, 12);
