...
test('v940 source and private 1.0.64 versions are aligned', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 64;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.64;/g) || []).length, 12);
