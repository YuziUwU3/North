...
test('v937 source and private 1.0.61 versions are aligned', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 61;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.61;/g) || []).length, 12);
