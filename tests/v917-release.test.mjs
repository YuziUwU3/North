...
test('v941 source and private 1.0.65 versions are aligned', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 65;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.65;/g) || []).length, 12);
