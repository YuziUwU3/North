...
test('v934 source and private 1.0.58 versions are aligned', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 58;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.58;/g) || []).length, 12);
