...
test('v1006 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1006/);
  assert.match(html,/sw\.js\?v=1006&r=v1006-call-moments-background-repair-1/);
});
