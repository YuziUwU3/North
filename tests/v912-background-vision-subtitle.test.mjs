...
test('main call subtitles replay the original animation on every update', () => {
  ...
  assert.match(app, /line\.style\.animation='csin \.3s ease'/);
});
