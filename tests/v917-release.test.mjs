...
test('v933 source and private 1.0.57 versions are aligned', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 57;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.57;/g) || []).length, 12);
