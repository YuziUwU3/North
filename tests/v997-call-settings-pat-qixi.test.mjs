...
test('v1005 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1005/);
  assert.match(html,/sw\.js\?v=1005&r=v1005-moments-background-delivery-1/);
});
