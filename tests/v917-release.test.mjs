...
test('v951 web source keeps private 1.0.72 compatibility', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 72;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.72;/g) || []).length, 12);
