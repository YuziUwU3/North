...
test('v935 source and private 1.0.59 versions are aligned', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 59;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.59;/g) || []).length, 12);
