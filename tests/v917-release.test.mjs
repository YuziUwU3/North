...
test('v936 source and private 1.0.60 versions are aligned', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 60;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.60;/g) || []).length, 12);
