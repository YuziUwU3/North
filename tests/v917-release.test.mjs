...
test('v938 source and private 1.0.62 versions are aligned', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 62;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.62;/g) || []).length, 12);
