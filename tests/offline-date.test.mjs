...
assert.match(source, /v749 \u00b7 \u6e38\u620f\u6d88\u606f\u7f16\u8f91\u4e0eAPI\u8def\u7ebf\u5feb\u6377\u5207\u6362/);
...
const summarizeAt = offEndSource.indexOf("await offSummarizeHistory(id,draft.id,false,mode)");
...
assert.match(offEndSource, /msgs:ended\.msgs,summaryMode:mode,summaryStatus:'pending'/);
...
assert.match(html, /app\.js\?v=749/);
