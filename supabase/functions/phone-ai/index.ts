...
- Clothing/outfit requests are different from object requests. If the request says the character should wear, put on, change into, show the character wearing, maid outfit, maid uniform, costume, suit, formal wear, shirt, uniform, coat, body shot, half-body shot, full-body shot, or "what are you wearing", the image must include the same current character with the exact gender and identity described in the request wearing that outfit. Preserve the requested clothing colors and framing. Do not output only clothes, a hanger, folded clothes, a bed, a desk, or an empty room.
- Wearable accessories must be shown actually worn by the same current character in the correct body location, unless the request explicitly says to remove them or photograph the item alone. Follow any framing the user explicitly requested. If framing was not specified, choose a natural close-up, half-body, full-body, seated, standing, or lifestyle composition that clearly shows the worn result; do not impose one fixed framing for an item category. Keep the face fully hidden. Never replace a requested worn-item photo with the item lying on a bed, desk, chair, floor, or in a box.
